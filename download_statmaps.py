# if necessary, download statmaps for data testing with this script. Credit: vsoch/brainart
...
outfolder = "/home/asier/git/neurovault_benchmark/ann-benchmark/data"
